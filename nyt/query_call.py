...
import chardet
import re
keys = ['&api-key=d68f5459a87f4434979f2154c1907cae', '&api-key=c75392ba82834401bc730b8a73388558','&api-key=d3925c4aa92c4946a1d5a2c3ea086e56', \
'&api-key=7e90712233444f859a2b6bfe175ed4c1', '&api-key=73eb5b6e18484c01b90f712564f13311', '&api-key=01f2b56924bc493e87d25177ef24a697', \
'&api-key=c75392ba82834401bc730b8a73388558', '&api-key=1caf159dde144de7bbfad988442cfde2''&api-key= b0d2f18b978e4702b4e89c961377e8aa', '&api-key= 793fedb2dc264e79928c7d5870fb340b', \
'&api-key =3d5fd6e15816487eb865dcfbbe0a69c9']

QUART_DICT = {.25:[],.5:[],.75:[], 1:[]}
DATES = {.25:[],.5:[],.75:[], 1:[]}
##below output directory used while on AWS
...
def convert_dict_to_csv():
	...
	for key in DATES.keys():
		key_string = str(key)
		name = "articles6/datesfor" + key_string + ".csv"
...
if __name__ == '__main__':
	##file_11_b, file_12, file_3_b, 
	
	# filename= '/home/csking1/buddhism/Finding/Output/file_16.txt'
	filename= '/home/csking1/buddhism/Finding/Output/file_6_b.txt'
	# filename= '/home/ec2-user/buddhism/Finding/Output/file_10_b.txt'
